...
life_history %>% 
  ...
  geom_col()+
  coord_flip()
  #sort = T arranges by count ; sort=F arranges by alphabetical
```
...
```
Two tricks to fix it
```{r}
options(scipen=999) #cancels scientific notation for the session; didnt help in this situation
  #used scale_y_log10() 
```
