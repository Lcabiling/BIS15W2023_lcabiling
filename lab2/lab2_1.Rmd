...
There is a missing value in the dataset of new_vector, so R is unable to give the answer by ignoring NA. Therefore, we can infer that NA will pause or prevent the value from being calculated. 
