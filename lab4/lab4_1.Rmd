...
```
pull out the variable that starts with a and ends with er
...
#They used -999 instead of NA 
# Question: how do we change this specific value or how do we exclude this value
```
